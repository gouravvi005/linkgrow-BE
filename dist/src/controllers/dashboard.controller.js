...
let DashboardController = class DashboardController {
    ...
    async getEcommerceDashboard() {
        ...
        const recentOrders = await Promise.all(recentPayments.map(async (p) => {
...
__decorate([
    (0, common_1.Get)('analytic'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getAnalyticDashboard", null);
__decorate([
    (0, common_1.Get)('ecommerce'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getEcommerceDashboard", null);
__decorate([
